...
o.push(m+'<br>*/</pre>');}
o.push('</div>');}}
return o.join('');};itself.jslint=itself;itself.edition='2010-01-20';return itself;}());(function(a){var e,i,input;if(!a[0]){print("Usage: jslint.js file.js");quit(1);}
input=readFile(a[0]);if(!input){print("jslint: Couldn't open file '"+a[0]+"'.");quit(1);}
if(!JSLINT(input,{bitwise:true,browser:true,devel:true,eqeqeq:false,immed:true,newcap:true,nomen:false,onevar:true,plusplus:true,regexp:true,rhino:true,undef:true,white:false,widget:true})){for(i=0;i<JSLINT.errors.length;i+=1){e=JSLINT.errors[i];if(e){print('Lint at line '+e.line+' character '+
